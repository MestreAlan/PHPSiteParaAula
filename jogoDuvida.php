		...
		<script>
			...
			function closePHP(){
				...
				$.ajax({
					...
					data: { tarefa: tarefa, conhecimentoProgramacao: conhecimentoProgramacao, tarefasFeitas: tarefasFeitas, jaJogouJogosCodedotOrg: jaJogouJogosCodedotOrg, nivelEducacional: nivelEducacional, login: login, perfil: perfil, aula: aula }
				})
					.done(function( msg ) {
